...
describe("Purchase Orders routes", () => {
  ...
  it("GET /purchase-orders/:id returns PO with items", async () => {
    const [po] = seedTable("purchase_orders", [{ userId: 1, id: 100, poNumber: "PO-0001", supplierName: "Test Supplier" },
    ]);
    seedTable("purchase_order_items", [{ userId: 1, id: 1, purchaseOrderId: 100, productName: "Widget", quantity: 5 },
    ]);
  ...
  it("PATCH /purchase-orders/:id updates status and records timestamps", async () => {
    seedTable("purchase_orders", [{ userId: 1, id: 200, poNumber: "PO-0002", status: "draft" },
    ]);
  ...
  it("DELETE /purchase-orders/:id removes PO and its items", async () => {
    ...
    seedTable("purchase_order_items", [{ userId: 1, id: 1, purchaseOrderId: 300, productName: "Item" },
    ]);
