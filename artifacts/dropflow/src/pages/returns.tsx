...
export default function ReturnsPage() {
  ...
  const handleOrderSelect = (val: string) => {
    ...
    if (o) {
      ...
      setRefundAmount(o.sellPrice ? String(o.sellPrice) : "");
    }
  };
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Track customer returns and manage refunds.
          </p>
        </div>
      ...
      {showForm && (
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm">Log New Return</CardTitle>
          </CardHeader>
      ...
      {returns.length === 0 ? (
        <Card className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Log a return when a customer sends a product back.
          </p>
        </Card>
      ) : (
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge
                        className={`text-xs border ${STATUS_STYLES[r.status] || STATUS_STYLES.requested}`}
                      >
                        {r.status}
                      </Badge>
                      {r.orderNumber && (
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {r.status === "requested" && (
                      <>
                        <Button
                          ...
                          onClick={() =>
                            updateMut.mutate({ id: r.id, status: "approved" })
                          }
                        >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            updateMut.mutate({ id: r.id, status: "rejected" })
                          }
                        >
                    ...
                    {r.status === "approved" && (
                      <Button
                        ...
                        className="text-xs h-7 text-green-400 border-green-500/30"
                        onClick={() =>
                          updateMut.mutate({ id: r.id, status: "refunded" })
                        }
                      >
                        <CheckCircle className="w-3 h-3 mr-1" />
                        Mark Refunded
