    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          AI-powered analysis — score any product's viral potential before you
          invest
        </p>
      </div>
          ...
          <Card className="col-span-1">
            <CardContent className="p-5 flex flex-col items-center gap-4">
              ...
              <div className="w-full space-y-2 pt-2 border-t border-border">
                ...
                {(["tiktok", "facebook", "instagram", "google"] as const).map(
                  (p) => (
                    <div key={p}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Card>
                <CardContent className="p-4">
                  ...
                  <Badge
                    variant="outline"
                    className={SATURATION_COLOR[result.saturation] ?? ""}
                  >
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <Badge
                    variant="outline"
                    className={MOMENTUM_COLOR[result.trendMomentum] ?? ""}
                  >
            ...
            {result.margin !== null && (
              <Card>
                <CardContent className="p-4">
                  ...
                  <p
                    className={`text-xl font-bold ${result.margin >= 40 ? "text-emerald-400" : result.margin >= 25 ? "text-yellow-400" : "text-red-400"}`}
                  >
                    {result.margin}%
                  </p>
                </CardContent>
      ...
      {!result && !isPending && (
        <div className="text-center py-16 text-muted-foreground">
          ...
          <p className="text-sm">
            Enter a product name above to get its virality score
          </p>
          <p className="text-xs mt-1 opacity-60">
            Scored across TikTok, Facebook, Instagram & Google
          </p>
        </div>
      )}
    </div>
