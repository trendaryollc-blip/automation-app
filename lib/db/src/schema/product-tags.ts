...
export const productTagLinksTable = pgTable(
  "product_tag_links",
  {
...
export const insertProductTagSchema = createInsertSchema(productTagsTable).omit(
  { id: true, createdAt: true },
);
export const insertProductTagLinkSchema =
  createInsertSchema(productTagLinksTable);
